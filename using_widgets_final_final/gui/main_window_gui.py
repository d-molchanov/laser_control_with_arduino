...
class MainWindowGUI:
    ...
    def init_gui(self):
        ...
        self.cbx_time_units = QComboBox(self)
        self.cbx_time_units.addItems(['μs', 'ms'])
        self.cbx_time_units.setFixedWidth(50)
        hbox_frequency.addWidget(self.cbx_time_units)
